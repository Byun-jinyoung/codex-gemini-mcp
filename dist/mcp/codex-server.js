...
import { AskCodexSchema, CheckJobStatusSchema, KillJobSchema, ListJobsSchema, WaitForJobSchema, } from "../tools/schema.js";
export function createCodexServer() {
    ...
    server.registerTool("ask_codex", {
        description: "Send a prompt to local Codex CLI for analysis and implementation tasks. Supports foreground or background execution; background mode returns job metadata and persists prompt/response artifacts under the runtime directory.",
