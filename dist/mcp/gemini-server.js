...
import { AskGeminiSchema, CheckJobStatusSchema, KillJobSchema, ListJobsSchema, WaitForJobSchema, } from "../tools/schema.js";
export function createGeminiServer() {
    const server = new McpServer({
        name: "gemini-mcp",
        version: VERSION,
    });
    server.registerTool("ask_gemini", {
        description: "Send a prompt to local Gemini CLI for design and implementation tasks. Supports foreground or background execution; background mode returns job metadata and persists prompt/response artifacts under the runtime directory.",
