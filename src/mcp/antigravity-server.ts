...
export function createAntigravityServer(): McpServer {
  ...
  server.registerTool(
    ...
    {
      description:
        "Send a prompt to local Antigravity CLI (agy) for design and implementation tasks. Supports foreground or background execution; background mode returns job metadata and persists prompt/response artifacts under the runtime directory.",
